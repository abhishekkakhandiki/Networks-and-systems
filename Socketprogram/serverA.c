...
void fileread()
{
    ...
    printf("The server A has following neighbour information \nNeighbour ----- cost\n");
...
/*Function to print adjacancy matrix*/
void printadjacancymatrix()
{
 ...
 a[2] = 'C';
 a[3] = 'D';
 printf("The adjacancy Matrix for server A is \n");
 printf("\nserver\tA\tB\tC\tD\n");
 for(i=0;i<4;i++)
 {
	 for(j =0 ;j <4; j++)
...
printf("For this connection with Client, The Server A has %s UDP port number and %s IP address\n",SERVERAUDPPORT,Ipadressforthisserver);
...
/*Socket functionality adopted from Beej and modified accordingly*/
int main()
{
